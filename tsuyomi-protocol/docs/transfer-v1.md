...
V1 remains an accepted legacy import contract. Current exporters emit [v4](transfer-v4.md); fields added by v2, v3, or v4 are never accepted under a document claiming `version: 1`.
