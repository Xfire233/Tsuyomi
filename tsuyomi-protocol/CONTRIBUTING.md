...
- Gate evidence must identify the exact protocol Git SHA, version, fixture digest, and downstream Android/extensions SHAs.
- Run `python tools/check_repository.py`; generated output, secrets, local state, and unknown root files are forbidden.
