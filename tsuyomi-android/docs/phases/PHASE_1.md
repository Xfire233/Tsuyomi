...
# Phase 1 evidence
> Terminology history: Historically published as Gate 1; immutable tag: `gate-1-baseline`.


- Evidence date: 2026-08-09
- Technical baseline: **PASS**
- Public-history conversion: **this evidence is preserved in the clean Monorepo baseline**
- Hosted Phase 2 admission gate: **PASS — public Monorepo, required checks, CODEOWNERS and protected `main` verified**
...
| Component | Phase 1 version | Public tag |
|---|---|---|
...
`tools/Doctor.ps1` passed and refreshed ignored `local.properties` from the environment SDK root. `tools/avd/Create-ReviewAvds.ps1` parsed successfully as PowerShell.
...
Original Phase 1 result: `BUILD SUCCESSFUL in 1m 2s`; 505 actionable tasks, 26 executed. A final focused build/lint/files regression after the last production fixes also passed in 26s with 402 actionable tasks.
...
Observed on the APK built from the Phase 1 implementation input:
...
| File | SHA-256 |
|---|---|
| `docs/phases/PHASE_1/assets/standard-settings.png` | `9b61faeb3e53802624ccc4ec86e17a2f22307c36755d2354f962197a56d5ca42` |
| `docs/phases/PHASE_1/assets/eink-settings-redraw.png` | `6f38a52ceffcd6ab4e79d6efe8eeb0eea2776dad85b21d796ff8af316230cbed` |
...
The public repository is `https://github.com/Xfire233/Tsuyomi`. Before Phase 2 development began, the following controls were observed on protected `main`:

1. the clean Monorepo baseline, immutable component tags and historical `gate-1-baseline` tag were pushed without importing private histories;
...
The Phase 2 admission gate is therefore open. Phase 2 work must use feature branches and pull requests; it must not bypass protected `main`.
