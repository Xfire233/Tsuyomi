...
These phases are ordered work scopes, not separate products. A later phase must keep all earlier contracts passing. Admission, review and release gates remain separate checkpoints with explicit decision owners and pass/fail outcomes.
...
## Phase 1: Android host shell and global display profile
...
## Phase 2: Wenku8 read-only vertical slice
...
## Phase 3: local library and migration
